...
This repository contains the DevOps capstone project

![Build Status](https://github.com/Shahzeb-Alam-Khan/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
